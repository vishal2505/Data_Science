...
tot_rating = app_data_set[0][-1] + app_data_set[1][-1] + app_data_set[2][-1] + app_data_set[3][-1] + app_data_set[4][-1]
avg_rating = tot_rating / len(app_data_set)
