...
for iter in content_ratings:
    content_ratings[iter] /= total_number_of_apps
    content_ratings[iter] *= 100
...
for keys in content_ratings:
    propertion = content_ratings[keys] / total_number_of_apps
    percentage = propertion * 100
    c_ratings_proportions[keys] = propertion
    c_ratings_percentages[keys] = percentage
